...
/** @internal */
export const CancelDeploymentCve$inboundSchema = z.object({
    id: z.string(),
    score: z.number(),
    description: z.string().optional(),
    link: z.string().optional(),
...
/** @internal */
export const CancelDeploymentCve$outboundSchema = z.object({
    id: z.string(),
    score: z.number(),
    description: z.string().optional(),
    link: z.string().optional(),
});
export function cancelDeploymentCveToJSON(cancelDeploymentCve) {
    return JSON.stringify(CancelDeploymentCve$outboundSchema.parse(cancelDeploymentCve));
}
export function cancelDeploymentCveFromJSON(jsonString) {
    return safeParse(jsonString, (x) => CancelDeploymentCve$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CancelDeploymentCve' from JSON`);
}
/** @internal */
export const CancelDeploymentCveVulnerabilities$inboundSchema = z.object({
    packageName: z.string(),
    packageVersion: z.string(),
    cve: z.lazy(() => CancelDeploymentCve$inboundSchema),
});
/** @internal */
export const CancelDeploymentCveVulnerabilities$outboundSchema = z.object({
    packageName: z.string(),
    packageVersion: z.string(),
    cve: z.lazy(() => CancelDeploymentCve$outboundSchema),
});
export function cancelDeploymentCveVulnerabilitiesToJSON(cancelDeploymentCveVulnerabilities) {
    return JSON.stringify(CancelDeploymentCveVulnerabilities$outboundSchema.parse(cancelDeploymentCveVulnerabilities));
}
export function cancelDeploymentCveVulnerabilitiesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => CancelDeploymentCveVulnerabilities$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CancelDeploymentCveVulnerabilities' from JSON`);
}
/** @internal */
...
export const CancelDeploymentResponseBody$inboundSchema = z.object({
    ...
    defaultRoute: z.string().optional(),
    canceledAt: z.number().optional(),
    cveVulnerabilities: z.array(z.lazy(() => CancelDeploymentCveVulnerabilities$inboundSchema)).optional(),
...
export const CancelDeploymentResponseBody$outboundSchema = z.object({
    ...
    defaultRoute: z.string().optional(),
    canceledAt: z.number().optional(),
    cveVulnerabilities: z.array(z.lazy(() => CancelDeploymentCveVulnerabilities$outboundSchema)).optional(),
    errorCode: z.string().optional(),
    errorLink: z.string().optional(),
    errorMessage: z.nullable(z.string()).optional(),
    errorStep: z.string().optional(),
