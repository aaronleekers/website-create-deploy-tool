...
export const CreateProjectDefaultResourceConfig$inboundSchema = z.object({
    ...
    buildMachineType: CreateProjectProjectsBuildMachineType$inboundSchema
        .optional(),
    isNSNBDisabled: z.boolean().optional(),
    buildQueue: z.lazy(() => CreateProjectProjectsResponseBuildQueue$inboundSchema).optional(),
});
/** @internal */
...
/** @internal */
export const ValuePreviousValue$inboundSchema = z.union([z.string(), z.number(), z.boolean()]);
/** @internal */
export const ValuePreviousValue$outboundSchema = z.union([z.string(), z.number(), z.boolean()]);
...
/** @internal */
export const ValueCurrentValue$inboundSchema = z.union([z.string(), z.number(), z.boolean()]);
/** @internal */
export const ValueCurrentValue$outboundSchema = z.union([z.string(), z.number(), z.boolean()]);
...
/** @internal */
export const CreateProjectValue4$inboundSchema = z.object({
    previousValue: z.union([z.string(), z.number(), z.boolean()]),
    currentValue: z.union([z.string(), z.number(), z.boolean()]),
});
/** @internal */
export const CreateProjectValue4$outboundSchema = z.object({
    previousValue: z.union([z.string(), z.number(), z.boolean()]),
    currentValue: z.union([z.string(), z.number(), z.boolean()]),
});
export function createProjectValue4ToJSON(createProjectValue4) {
    return JSON.stringify(CreateProjectValue4$outboundSchema.parse(createProjectValue4));
}
export function createProjectValue4FromJSON(jsonString) {
    return safeParse(jsonString, (x) => CreateProjectValue4$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CreateProjectValue4' from JSON`);
}
/** @internal */
export const CreateProjectValue$inboundSchema = z.union([
...
/** @internal */
export const CreateProjectValue$outboundSchema = z.union([
...
/** @internal */
export const CreateProjectCveShield$inboundSchema = z.object({
    enabled: z.boolean(),
    threshold: z.number().optional(),
    cveList: z.array(z.string()).optional(),
});
/** @internal */
export const CreateProjectCveShield$outboundSchema = z.object({
    enabled: z.boolean(),
    threshold: z.number().optional(),
    cveList: z.array(z.string()).optional(),
});
export function createProjectCveShieldToJSON(createProjectCveShield) {
    return JSON.stringify(CreateProjectCveShield$outboundSchema.parse(createProjectCveShield));
}
export function createProjectCveShieldFromJSON(jsonString) {
    return safeParse(jsonString, (x) => CreateProjectCveShield$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CreateProjectCveShield' from JSON`);
}
/** @internal */
export const CreateProjectResponseBody$inboundSchema = z.object({
    ...
    dismissedToasts: z.array(z.lazy(() => CreateProjectDismissedToasts$inboundSchema)).optional(),
