...
/** @internal */
export const Cve$inboundSchema = z
    .object({
    id: z.string(),
    score: z.number(),
    description: z.string().optional(),
...
/** @internal */
export const Cve$outboundSchema = z
    .object({
    id: z.string(),
    score: z.number(),
    description: z.string().optional(),
...
export function cveToJSON(cve) {
    return JSON.stringify(Cve$outboundSchema.parse(cve));
}
export function cveFromJSON(jsonString) {
    return safeParse(jsonString, (x) => Cve$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Cve' from JSON`);
}
/** @internal */
export const CveVulnerabilities$inboundSchema = z.object({
    packageName: z.string(),
    packageVersion: z.string(),
    cve: z.lazy(() => Cve$inboundSchema),
});
/** @internal */
export const CveVulnerabilities$outboundSchema = z.object({
    packageName: z.string(),
    packageVersion: z.string(),
    cve: z.lazy(() => Cve$outboundSchema),
});
export function cveVulnerabilitiesToJSON(cveVulnerabilities) {
    return JSON.stringify(CveVulnerabilities$outboundSchema.parse(cveVulnerabilities));
}
export function cveVulnerabilitiesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => CveVulnerabilities$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CveVulnerabilities' from JSON`);
}
/** @internal */
...
export const RoutesHas$outboundSchema = z.union([
    ...
    z.lazy(() => CreateDeploymentHas2$outboundSchema).and(z.object({ type: z.literal("header") })),
    z.lazy(() => CreateDeploymentHas2$outboundSchema).and(z.object({ type: z.literal("cookie") })),
    z.lazy(() => CreateDeploymentHas2$outboundSchema).and(z.object({ type: z.literal("query") })),
]);
...
export const Routes1$inboundSchema = z.object({
    ...
    transforms: z.array(z.lazy(() => CreateDeploymentRoutesTransforms$inboundSchema)).optional(),
    env: z.array(z.string()).optional(),
