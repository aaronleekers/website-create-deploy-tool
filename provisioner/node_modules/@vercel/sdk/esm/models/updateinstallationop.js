...
/** @internal */
export const Notification$inboundSchema = z.union([z.lazy(() => Notification1$inboundSchema), z.string()]);
/** @internal */
export const Notification$outboundSchema = z.union([z.lazy(() => Notification1$outboundSchema), z.string()]);
