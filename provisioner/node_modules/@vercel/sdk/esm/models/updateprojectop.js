...
/** @internal */
export const PreviousValue$inboundSchema = z.union([z.number(), z.boolean(), z.string()]);
/** @internal */
export const PreviousValue$outboundSchema = z.union([z.number(), z.boolean(), z.string()]);
...
/** @internal */
export const CurrentValue$inboundSchema = z.union([z.number(), z.boolean(), z.string()]);
/** @internal */
export const CurrentValue$outboundSchema = z.union([z.number(), z.boolean(), z.string()]);
...
export const UpdateProjectRequestBody$inboundSchema = z.object({
    ...
    dismissedToasts: z.array(z.lazy(() => UpdateProjectDismissedToasts$inboundSchema)).optional(),
});
/** @internal */
...
export const UpdateProjectDefaultResourceConfig$inboundSchema = z.object({
    ...
    buildMachineType: UpdateProjectProjectsResponseBuildMachineType$inboundSchema
        .optional(),
    isNSNBDisabled: z.boolean().optional(),
    buildQueue: z.lazy(() => UpdateProjectProjectsResponseBuildQueue$inboundSchema).optional(),
});
/** @internal */
...
export const UpdateProjectAiBots$inboundSchema = z.object({
    active: z.boolean(),
    action: UpdateProjectProjectsResponse200ApplicationJSONResponseBodyAction$inboundSchema
        .optional(),
});
/** @internal */
...
/** @internal */
export const UpdateProjectValuePreviousValue$inboundSchema = z.union([z.string(), z.number(), z.boolean()]);
/** @internal */
export const UpdateProjectValuePreviousValue$outboundSchema = z.union([z.string(), z.number(), z.boolean()]);
...
/** @internal */
export const UpdateProjectValueCurrentValue$inboundSchema = z.union([z.string(), z.number(), z.boolean()]);
/** @internal */
export const UpdateProjectValueCurrentValue$outboundSchema = z.union([z.string(), z.number(), z.boolean()]);
...
/** @internal */
export const UpdateProjectValue4$inboundSchema = z.object({
    previousValue: z.union([z.string(), z.number(), z.boolean()]),
    currentValue: z.union([z.string(), z.number(), z.boolean()]),
});
/** @internal */
export const UpdateProjectValue4$outboundSchema = z.object({
    previousValue: z.union([z.string(), z.number(), z.boolean()]),
    currentValue: z.union([z.string(), z.number(), z.boolean()]),
});
export function updateProjectValue4ToJSON(updateProjectValue4) {
    return JSON.stringify(UpdateProjectValue4$outboundSchema.parse(updateProjectValue4));
}
export function updateProjectValue4FromJSON(jsonString) {
    return safeParse(jsonString, (x) => UpdateProjectValue4$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UpdateProjectValue4' from JSON`);
}
/** @internal */
export const UpdateProjectValue$inboundSchema = z.union([
...
/** @internal */
export const UpdateProjectValue$outboundSchema = z.union([
...
/** @internal */
export const UpdateProjectCveShield$inboundSchema = z.object({
    enabled: z.boolean(),
    threshold: z.number().optional(),
    cveList: z.array(z.string()).optional(),
});
/** @internal */
export const UpdateProjectCveShield$outboundSchema = z.object({
    enabled: z.boolean(),
    threshold: z.number().optional(),
    cveList: z.array(z.string()).optional(),
});
export function updateProjectCveShieldToJSON(updateProjectCveShield) {
    return JSON.stringify(UpdateProjectCveShield$outboundSchema.parse(updateProjectCveShield));
}
export function updateProjectCveShieldFromJSON(jsonString) {
    return safeParse(jsonString, (x) => UpdateProjectCveShield$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UpdateProjectCveShield' from JSON`);
}
/** @internal */
export const UpdateProjectResponseBody$inboundSchema = z.object({
    ...
    dismissedToasts: z.array(z.lazy(() => UpdateProjectProjectsDismissedToasts$inboundSchema)).optional(),
