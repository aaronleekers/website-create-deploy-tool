...
/** @internal */
export const GetProjectsConfiguration$inboundSchema = z.nativeEnum(GetProjectsConfiguration);
/** @internal */
export const GetProjectsConfiguration$outboundSchema = GetProjectsConfiguration$inboundSchema;
/** @internal */
export const GetProjectsBuildQueue$inboundSchema = z.object({
    configuration: GetProjectsConfiguration$inboundSchema.optional(),
});
/** @internal */
export const GetProjectsBuildQueue$outboundSchema = z.object({
    configuration: GetProjectsConfiguration$outboundSchema.optional(),
});
export function getProjectsBuildQueueToJSON(getProjectsBuildQueue) {
    return JSON.stringify(GetProjectsBuildQueue$outboundSchema.parse(getProjectsBuildQueue));
}
export function getProjectsBuildQueueFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetProjectsBuildQueue$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetProjectsBuildQueue' from JSON`);
}
/** @internal */
...
/** @internal */
export const GetProjectsProjectsConfiguration$inboundSchema = z.nativeEnum(GetProjectsProjectsConfiguration);
/** @internal */
export const GetProjectsProjectsConfiguration$outboundSchema = GetProjectsProjectsConfiguration$inboundSchema;
/** @internal */
export const GetProjectsProjectsBuildQueue$inboundSchema = z.object({
    configuration: GetProjectsProjectsConfiguration$inboundSchema.optional(),
});
/** @internal */
export const GetProjectsProjectsBuildQueue$outboundSchema = z.object({
    configuration: GetProjectsProjectsConfiguration$outboundSchema.optional(),
});
export function getProjectsProjectsBuildQueueToJSON(getProjectsProjectsBuildQueue) {
    return JSON.stringify(GetProjectsProjectsBuildQueue$outboundSchema.parse(getProjectsProjectsBuildQueue));
}
export function getProjectsProjectsBuildQueueFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetProjectsProjectsBuildQueue$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetProjectsProjectsBuildQueue' from JSON`);
}
/** @internal */
...
/** @internal */
export const GetProjectsStaticIps$inboundSchema = z.object({
    builds: z.boolean(),
    enabled: z.boolean(),
    regions: z.array(z.string()),
});
/** @internal */
export const GetProjectsStaticIps$outboundSchema = z.object({
    builds: z.boolean(),
    enabled: z.boolean(),
    regions: z.array(z.string()),
});
export function getProjectsStaticIpsToJSON(getProjectsStaticIps) {
    return JSON.stringify(GetProjectsStaticIps$outboundSchema.parse(getProjectsStaticIps));
}
export function getProjectsStaticIpsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetProjectsStaticIps$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetProjectsStaticIps' from JSON`);
}
/** @internal */
...
/** @internal */
export const GetProjectsCve55182MigrationAppliedFrom$inboundSchema = z
    .nativeEnum(GetProjectsCve55182MigrationAppliedFrom);
/** @internal */
export const GetProjectsCve55182MigrationAppliedFrom$outboundSchema = GetProjectsCve55182MigrationAppliedFrom$inboundSchema;
/** @internal */
export const GetProjectsSsoProtection$inboundSchema = z.object({
    deploymentType: GetProjectsDeploymentType$inboundSchema,
    cve55182MigrationAppliedFrom: z.nullable(GetProjectsCve55182MigrationAppliedFrom$inboundSchema).optional(),
});
/** @internal */
export const GetProjectsSsoProtection$outboundSchema = z.object({
    deploymentType: GetProjectsDeploymentType$outboundSchema,
    cve55182MigrationAppliedFrom: z.nullable(GetProjectsCve55182MigrationAppliedFrom$outboundSchema).optional(),
});
...
/** @internal */
export const GetProjectsProjectsResponse200ApplicationJSONAction$inboundSchema = z.nativeEnum(GetProjectsProjectsResponse200ApplicationJSONAction);
/** @internal */
export const GetProjectsProjectsResponse200ApplicationJSONAction$outboundSchema = GetProjectsProjectsResponse200ApplicationJSONAction$inboundSchema;
/** @internal */
...
/** @internal */
export const GetProjectsValuePreviousValue$inboundSchema = z.union([z.string(), z.number(), z.boolean()]);
/** @internal */
export const GetProjectsValuePreviousValue$outboundSchema = z.union([z.string(), z.number(), z.boolean()]);
...
/** @internal */
export const GetProjectsValueCurrentValue$inboundSchema = z.union([z.string(), z.number(), z.boolean()]);
/** @internal */
export const GetProjectsValueCurrentValue$outboundSchema = z.union([z.string(), z.number(), z.boolean()]);
...
/** @internal */
export const GetProjectsValue4$inboundSchema = z.object({
    previousValue: z.union([z.string(), z.number(), z.boolean()]),
    currentValue: z.union([z.string(), z.number(), z.boolean()]),
});
/** @internal */
export const GetProjectsValue4$outboundSchema = z.object({
    previousValue: z.union([z.string(), z.number(), z.boolean()]),
    currentValue: z.union([z.string(), z.number(), z.boolean()]),
});
export function getProjectsValue4ToJSON(getProjectsValue4) {
    return JSON.stringify(GetProjectsValue4$outboundSchema.parse(getProjectsValue4));
}
export function getProjectsValue4FromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetProjectsValue4$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetProjectsValue4' from JSON`);
}
/** @internal */
export const GetProjectsValue$inboundSchema = z.union([
...
/** @internal */
export const GetProjectsValue$outboundSchema = z.union([
...
/** @internal */
export const GetProjectsDismissedToasts$inboundSchema = z.object({
    key: z.string(),
...
/** @internal */
export const GetProjectsDismissedToasts$outboundSchema = z.object({
    key: z.string(),
    dismissedAt: z.number(),
...
export function getProjectsDismissedToastsToJSON(getProjectsDismissedToasts) {
    return JSON.stringify(GetProjectsDismissedToasts$outboundSchema.parse(getProjectsDismissedToasts));
}
export function getProjectsDismissedToastsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetProjectsDismissedToasts$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetProjectsDismissedToasts' from JSON`);
}
/** @internal */
export const GetProjectsCveShield$inboundSchema = z.object({
    enabled: z.boolean(),
    threshold: z.number().optional(),
    cveList: z.array(z.string()).optional(),
});
/** @internal */
export const GetProjectsCveShield$outboundSchema = z.object({
    enabled: z.boolean(),
    threshold: z.number().optional(),
    cveList: z.array(z.string()).optional(),
});
export function getProjectsCveShieldToJSON(getProjectsCveShield) {
    return JSON.stringify(GetProjectsCveShield$outboundSchema.parse(getProjectsCveShield));
}
export function getProjectsCveShieldFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetProjectsCveShield$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetProjectsCveShield' from JSON`);
}
/** @internal */
export const GetProjectsProjects$inboundSchema = z.object({
    ...
    dismissedToasts: z.array(z.lazy(() => GetProjectsDismissedToasts$inboundSchema)).optional(),
...
export const GetProjectsProjects$outboundSchema = z.object({
    ...
    hasDeployments: z.boolean().optional(),
    dismissedToasts: z.array(z.lazy(() => GetProjectsDismissedToasts$outboundSchema)).optional(),
