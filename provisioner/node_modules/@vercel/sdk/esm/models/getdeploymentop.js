...
/** @internal */
export const ResponseBodyCve$inboundSchema = z.object({
    id: z.string(),
    score: z.number(),
    description: z.string().optional(),
    link: z.string().optional(),
...
/** @internal */
export const ResponseBodyCve$outboundSchema = z.object({
    id: z.string(),
    score: z.number(),
    description: z.string().optional(),
    link: z.string().optional(),
});
export function responseBodyCveToJSON(responseBodyCve) {
    return JSON.stringify(ResponseBodyCve$outboundSchema.parse(responseBodyCve));
}
export function responseBodyCveFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ResponseBodyCve$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ResponseBodyCve' from JSON`);
}
/** @internal */
export const ResponseBodyCveVulnerabilities$inboundSchema = z.object({
    packageName: z.string(),
    packageVersion: z.string(),
    cve: z.lazy(() => ResponseBodyCve$inboundSchema),
});
/** @internal */
export const ResponseBodyCveVulnerabilities$outboundSchema = z.object({
    packageName: z.string(),
    packageVersion: z.string(),
    cve: z.lazy(() => ResponseBodyCve$outboundSchema),
});
export function responseBodyCveVulnerabilitiesToJSON(responseBodyCveVulnerabilities) {
    return JSON.stringify(ResponseBodyCveVulnerabilities$outboundSchema.parse(responseBodyCveVulnerabilities));
}
export function responseBodyCveVulnerabilitiesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ResponseBodyCveVulnerabilities$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ResponseBodyCveVulnerabilities' from JSON`);
}
/** @internal */
...
export const GetDeploymentResponseBody2$inboundSchema = z.object({
    ...
    cveVulnerabilities: z.array(z.lazy(() => ResponseBodyCveVulnerabilities$inboundSchema)).optional(),
...
export const GetDeploymentResponseBody2$outboundSchema = z.object({
    ...
    defaultRoute: z.string().optional(),
    canceledAt: z.number().optional(),
    cveVulnerabilities: z.array(z.lazy(() => ResponseBodyCveVulnerabilities$outboundSchema)).optional(),
    errorCode: z.string().optional(),
    errorLink: z.string().optional(),
    errorMessage: z.nullable(z.string()).optional(),
    errorStep: z.string().optional(),
...
/** @internal */
export const GetDeploymentResponseBodyCve$inboundSchema = z.object({
    id: z.string(),
    score: z.number(),
    description: z.string().optional(),
    link: z.string().optional(),
...
/** @internal */
export const GetDeploymentResponseBodyCve$outboundSchema = z.object({
    id: z.string(),
    score: z.number(),
    description: z.string().optional(),
    link: z.string().optional(),
});
export function getDeploymentResponseBodyCveToJSON(getDeploymentResponseBodyCve) {
    return JSON.stringify(GetDeploymentResponseBodyCve$outboundSchema.parse(getDeploymentResponseBodyCve));
}
export function getDeploymentResponseBodyCveFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetDeploymentResponseBodyCve$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetDeploymentResponseBodyCve' from JSON`);
}
/** @internal */
export const GetDeploymentResponseBodyCveVulnerabilities$inboundSchema = z.object({
    packageName: z.string(),
    packageVersion: z.string(),
    cve: z.lazy(() => GetDeploymentResponseBodyCve$inboundSchema),
});
/** @internal */
export const GetDeploymentResponseBodyCveVulnerabilities$outboundSchema = z.object({
    packageName: z.string(),
    packageVersion: z.string(),
    cve: z.lazy(() => GetDeploymentResponseBodyCve$outboundSchema),
});
export function getDeploymentResponseBodyCveVulnerabilitiesToJSON(getDeploymentResponseBodyCveVulnerabilities) {
    return JSON.stringify(GetDeploymentResponseBodyCveVulnerabilities$outboundSchema.parse(getDeploymentResponseBodyCveVulnerabilities));
}
export function getDeploymentResponseBodyCveVulnerabilitiesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetDeploymentResponseBodyCveVulnerabilities$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetDeploymentResponseBodyCveVulnerabilities' from JSON`);
}
/** @internal */
...
export const GetDeploymentResponseBody1$inboundSchema = z.object({
    ...
    defaultRoute: z.string().optional(),
    canceledAt: z.number().optional(),
    cveVulnerabilities: z.array(z.lazy(() => GetDeploymentResponseBodyCveVulnerabilities$inboundSchema)).optional(),
    errorCode: z.string().optional(),
    errorLink: z.string().optional(),
    errorMessage: z.nullable(z.string()).optional(),
    errorStep: z.string().optional(),
...
export const GetDeploymentResponseBody1$outboundSchema = z.object({
    ...
    defaultRoute: z.string().optional(),
    canceledAt: z.number().optional(),
    cveVulnerabilities: z.array(z.lazy(() => GetDeploymentResponseBodyCveVulnerabilities$outboundSchema)).optional(),
    errorCode: z.string().optional(),
    errorLink: z.string().optional(),
    errorMessage: z.nullable(z.string()).optional(),
    errorStep: z.string().optional(),
